    ...
    return (
      <VideosContext.Consumer>
        {value => {
          ...
          return (
            <GamingContainer bgColor={changeBgColor}>
              {gamingList.map(eachItem => (
                <Link
                  ...
                  key={eachItem.id}
                >
                  <EachGamingContainer key={eachItem.id}>
                    <GamingThumbnailImage
                      alt="gaming"
                      src={eachItem.thumbnailUrl}
                    />
                    <GamingTitle color={changeHeading}>
                      {eachItem.title}
                    </GamingTitle>
                    <GamingWatching color={changeHeading}>
    ...
    return (
      <VideosContext.Consumer>
        {value => {
          ...
          const iconBgColor = activeTabId === 'Gaming' ? '#ff0b37' : ''
              ...
              <HomeMainContainer>
                  ...
                  <SelectOneItemContainer>
                    ...
                    <Link to="/gaming" style={{textDecoration: 'none'}}>
                      <EachSelectContainer onClick={onChangeGamingTabId}>
                        <SiYoutubegaming color={iconBgColor} />
                        <DisplayText color={navigationTextColor}>
                          Gaming
                        </DisplayText>
                      </EachSelectContainer>
                ...
                <GamingMainContainer>
                  <GamingHeader bgColor={trendingHeaderColor}>
                    ...
                    <GamingText color={navigationTextColor}>Gaming</GamingText>
                  </GamingHeader>
